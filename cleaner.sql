...
from pedido
where year(fecha_entrega) = 2009 and estado <> 'Entregado' and estado <> 'Pendiente'
...
FROM pedido
WHERE  estado <> 'Pendiente' and estado <> 'Rechazado' and  fecha_entrega  AND MONTH(fecha_entrega) = 1;
